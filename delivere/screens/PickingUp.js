        ...
        <View style={styles.panel}>
          ...
          <ScrollView {...this._panResponder.panHandlers}>
            <View style={styles.panelHeader}>
              <View style={{borderBottomWidth: 1, borderBottomColor:'#c9bfbf', paddingBottom: 30, paddingLeft: 8, marginBottom: 15}}>
                <Text style={styles.textHeader}>Twisted Taco</Text>
                <Text style={[styles.textHeader, {marginTop: 5, marginBottom: 10, fontSize: 17}]}>Cox Hall: 569 Asbury Cir, Atlanta, GA 30322</Text>
                <TouchableOpacity>
                  <Block style={{width: normalize(180), height: normalize(50), backgroundColor: '#5E72E4', borderRadius: 100}} row middle>
              ...
              <View style={{borderBottomWidth: 1, borderBottomColor:'#c9bfbf', paddingBottom: 25, marginBottom: 15}}>
                ...
                <Block row style={{alignItems:'center', paddingLeft: 10, paddingTop: 20}}>
                  <TouchableOpacity>
                    <Block style={{width: .27*width, height: 50, borderRadius: 100, borderWidth: 1, borderColor: '#c9bfbf'}} row middle>
                      <Icon name="phone" family="Entypo" size={normalize(25)} color='#5E72E4' />
                      <Text style={{fontSize: normalize(17), color:'#5E72E4'}}>Call</Text>
                    </Block>
                  </TouchableOpacity>
                  <TouchableOpacity style={{marginLeft:normalize(12)}}>
                    <Block style={{width: .27*width, height: 50, borderRadius: 100, borderWidth: 1, borderColor: '#c9bfbf'}} row middle>
                      <Icon name="chat" family="Entypo" size={normalize(25)} color='#5E72E4'/>
                      <Text style={{fontSize: normalize(17), color:'#5E72E4', marginLeft: 8}}>Text</Text>
                    </Block>
                  </TouchableOpacity>
                  <TouchableOpacity style={{marginLeft:normalize(12)}}>
                    <Block style={{width: .27*width, height: 50, borderRadius: 100, borderWidth: 1, borderColor: '#c9bfbf'}} row middle>
                      <Icon name="email" family="MaterialIcons" size={normalize(25)} color='#5E72E4'/>
                      <Text style={{fontSize: normalize(17), color:'#5E72E4', marginLeft: 8}}>Email</Text>
                    </Block>
                  </TouchableOpacity>
                </Block>
              </View>
